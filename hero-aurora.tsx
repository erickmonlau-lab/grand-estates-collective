      {/* ════════════════════════════════════════════════════════════
          HERO — "Visibilidad Absoluta" (Aurora Background)
          Concept: Maximum legibility, no erratic mouse movements.
          A beautiful, slow-moving CSS Aurora background (Blue & Silver).
          ════════════════════════════════════════════════════════════ */}
      <section className="relative min-h-[100svh] w-full overflow-hidden bg-white flex flex-col items-center justify-center pt-24 pb-12">
        
        {/* ── BACKGROUND: Realistic Real Estate ── */}
        <div 
          className="absolute inset-0 z-0 pointer-events-none"
          style={{
            backgroundImage: `url(${realisticImage})`,
        ...
        {/* ── CENTRAL TYPOGRAPHY (Maximum Contrast) ── */}
        <div className="relative z-10 w-full max-w-[1200px] mx-auto px-6 flex flex-col items-center text-center pointer-events-none mb-12">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-3 bg-white/80 backdrop-blur-sm px-5 py-2.5 rounded-full shadow-sm border border-slate-200 mb-8"
          >
            ...
            <span className="font-mono text-[10px] font-bold text-slate-600 tracking-[0.2em] uppercase">
          ...
          <motion.h1 
            ...
            className="text-slate-900 leading-[0.95] tracking-tight drop-shadow-sm"
            style={{ 
          ...
          <motion.p 
            ...
            className="mt-8 text-slate-600 font-medium text-lg md:text-xl max-w-2xl leading-relaxed"
          >
        ...
        {/* ── THE PROTAGONIST: Solid, Centered Search Block ── */}
        <motion.div 
        ...
        >
          {/* Static White Block (No 3D tilt, just pure clean UI) */}
          <div 
            className="w-full bg-white rounded-[2rem] md:rounded-[3rem] p-3 md:p-4 border border-slate-200/60 flex flex-col md:flex-row items-stretch gap-2 transition-transform duration-300 hover:shadow-2xl"
            style={{
              boxShadow: '0 25px 60px -15px rgba(0, 0, 0, 0.05), 0 10px 30px -10px rgba(0, 0, 0, 0.03)',
            }}
          >
        ...
        >
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-black text-slate-900 tracking-tighter">350<span className="text-primary-blue">+</span></div>
            <div className="font-mono text-[9px] font-bold text-slate-400 tracking-[0.2em] uppercase mt-2">Comunidades</div>
          </div>
          <div className="w-px h-10 bg-slate-200" />
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-black text-slate-900 tracking-tighter">98<span className="text-primary-blue">%</span></div>
            <div className="font-mono text-[9px] font-bold text-slate-400 tracking-[0.2em] uppercase mt-2">Eficiencia</div>
          </div>
          <div className="w-px h-10 bg-slate-200 hidden md:block" />
          <div className="text-center hidden md:block">
            <div className="text-3xl md:text-4xl font-black text-slate-900 tracking-tighter">15<span className="text-primary-blue">y</span></div>
