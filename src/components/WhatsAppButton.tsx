  ...
  return (
    ...
    >
      ...
      >
        ...
        <svg width="24" height="24" viewBox="0 0 24 24" className="w-6 h-6 sm:w-8 sm:h-8 fill-white group-hover:rotate-12 transition-transform duration-300 relative z-10">
