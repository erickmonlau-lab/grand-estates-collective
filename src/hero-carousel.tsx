  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        {/* On desktop: right half. On mobile: centered vertically on the right half */}
        <div className="absolute right-0 top-1/2 -translate-y-[56%] sm:top-0 sm:translate-y-0 w-[60%] aspect-[55/72] sm:aspect-auto sm:h-full sm:w-[65%] lg:w-[50%] xl:w-[46%] pointer-events-none bg-[#F8FAFC] sm:bg-transparent overflow-hidden">
          ...
          <div className="sm:hidden absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-[#F8FAFC] from-[25%] via-[#F8FAFC]/80 to-transparent pointer-events-none" />
          {/* Feathering: right edge — mobile only */}
          <div className="sm:hidden absolute inset-y-0 right-0 w-12 bg-gradient-to-l from-[#F8FAFC] to-transparent pointer-events-none" />
          {/* Feathering: bottom edge with solid base at bottom */}
